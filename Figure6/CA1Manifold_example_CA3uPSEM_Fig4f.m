...
% Fig.4i, bottom panels, uPSEM
animalprefix = 'IZ34'; % animal name
SesssionCondition = 'Final'; %Final/Saline
prefix = 'IZ34_436um_210311_sess7'; % animal prefix
...
%% run UMAP
spike_umap = run_umap(spike_matrix_animal,'min_dist',0.6,'n_neighbors',50,'metric','cosine','n_components',3,'template_file','CA3_uPSEM_template.mat'); % use the previously acquired template file for repreducibility, you can also run it anew
